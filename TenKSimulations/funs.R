## ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: ##
## misc functions used for TenKsimulations.Rmd or fn_simdt.R
## (1) num2cat(): convert numerical variables to categorical variables 
## (2) cat201(): creates indicator variables for categorical ones
## (3) summ_results(): summarizes the simulation results
## (4) get_max(): find the max means from the list of mean dataframes
## (5) loop_wt_sd(): loop thru different variables with different weights
## ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: ##
...
## simulations are done in TenKsimulations.Rmd, and the below function    ##
