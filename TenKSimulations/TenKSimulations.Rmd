...
The chunk below runs 10 simulations. To change this, set `rs_k <- rand_seeds`.
...
### Summary of difference in response variable Y

Figure 6 in manuscript: boxplot of mean difference in response variable Y
...
Figure 7 in manuscript: boxplot of mean difference in response variable Yc
