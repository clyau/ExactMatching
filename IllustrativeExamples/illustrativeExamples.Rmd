...
means.wtd.3.f <- data.frame(x1 = os.dt3.f$wtd.summ[3], 
                            ...
                            x2.txt = os.dt3.f$wtd.summ[4] - 0.15) 
```
...
dt.means.rev <- dt.means.rev %>% 
  mutate(which.means = 'IPD 1 + IPD 2',
         ...
         x1.txt = x1,
         x2.txt = ifelse(example == 'example 1', x2 - 0.01,
...
## 2025-02-04: change IPD 1 to IPD A, IPD 2 to IPD B
# dt.means.rev <- dt.means.rev %>%
#   mutate(which.means.old = which.means) %>%
#   mutate(which.means = ifelse(which.means.old == 'IPD 1', 'IPD A',
#                               ifelse(which.means.old == 'IPD 2', 'IPD B',
#                                      ifelse(which.means.old == 'IPD 1 + IPD 2', 'IPD A + IPD B', 
#                                             which.means.old)))
#   )
```
